...
import { modelGatewayService } from '../intelligence/modelGatewayService'
import { getPublicRuntimeConfig, getRuntimeIntegrationStatus } from '../../common/config/runtimeConfigService'
import { sqliteConfigStoreService } from '../../common/storage/sqliteConfigStoreService'
import { driveControllerService } from '../vault/driveControllerService'
import {
  PranaRuntimeConfig,
  getPranaRuntimeConfig,
  setPranaRuntimeConfig,
  validatePranaRuntimeConfig
} from '../../common/config/pranaRuntimeConfig'
import { skillSystemService } from '../agent/skillSystemService'
import { vaultService } from '../vault/vaultService'
import { operationsService } from '../operations/operationsService'
import { startupOrchestratorService } from '../operations/startupOrchestratorService'
import { contextEngineService } from '../context/contextEngineService'
import type { ContextMessageRole } from '../context/contextEngineService'
import { subagentService } from '../agent/subagentService'
...
import type { MemoryClassification } from '../context/memoryIndexService'
import { memoryQueryService } from '../context/memoryQueryService'
import { commandRouterService } from '../orchestration/commandRouterService'
import { queueService } from '../orchestration/queueService'
import { workOrderService } from '../operations/workOrderService'
import { localExecutionProviderService, ModelProviderType } from '../operations/localExecutionProviderService'
import { skillRegistryService } from '../agent/skillRegistry'
import type { SkillType } from '../agent/skillRegistry'
import { coreRegistryService } from '../registry/coreRegistryService'
import { channelRouterService } from '../communication/channelRouterService'
import { ChannelMessageEnvelope } from '../../common/types/channelAdapterTypes'
import { syncProviderService } from '../sync/syncProviderService'
import { runtimeModelAccessService } from '../intelligence/runtimeModelAccessService'
import { configureRegistryRuntime, RegistryRuntimeConfig } from '../registry/registryRuntimeService'
import { emailOrchestratorService } from '../communication/emailOrchestratorService'
import { templateService } from '../operations/templateService'
import type { VisualTemplateFormat, VisualTemplateType } from '../operations/templateService'
import { visualIdentityService } from '../operations/visualIdentityService'
...
import type { RuntimeCapabilities, SandboxFixture } from '../../common/types/sandboxTypes'
...
export const registerIpcHandlers = (options?: {
  ...
  ipcMain.handle('email-general:configure', safe(async (_event, payload: { apiKey: string; inboxId: string }) => {
    ...
    const { configureEmailService } = await import('../communication/emailService');
  ...
  ipcMain.handle('email-general:send', safe(async (_event, payload: { options: { to: string[]; subject: string; templateName: string; data: any } }) => {
    ...
    const { sendEmail } = await import('../communication/emailService');

...
```
```
# Runtime Map Template Source

Use the canonical runtime-map template located at:
...
Populate template fields ONLY.

---

# Template Compliance Requirement

Generated runtime maps are considered invalid if they:
...
The template is architectural governance law.

---

# Runtime Map Update Requirement

When updating existing runtime maps:

* preserve existing valid structure
* preserve historical governance data when still valid
* update only changed runtime behavior
